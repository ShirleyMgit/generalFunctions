function runBeta_distSpN_Cor_Melemnts_rsatoolboxCleanedD(nsb,areaM,dirT,nFiles,nameSearchL,dirL,nameOF,runN)
%runN  = 1;

%nameOF = 'corBeta_DistSpN_L200_MelementsNoNan2';%'corBeta_DistSpN_L200_MelementsNewC';%200V';
funPointer = @BetaCor_DistSpN_LooFixNormMElementsNoNanInf_RSAtoolboxCheckF;
nSess = 4;
...
nameDirO = [data_path,nameOF,'cleanD_All/searchLightAll/sub',num2str(vnpar(nsb)),'/',areaM,'/'];
mkdir(nameDirO);
