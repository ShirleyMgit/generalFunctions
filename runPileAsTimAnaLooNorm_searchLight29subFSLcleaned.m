function runPileAsTimAnaLooNorm_searchLight29subFSLcleaned(nsb,areaM,dirT,nFiles,nameSearchL,dirL,isPC,sflag)
runN  = 'pTim1';%2;
% path definitions:
...
nameDirO = [data_path,dirT,'/searchLightAllpileAsTim',sflag,'/sub',num2str(vnpar(nsb)),'/',areaM,'/'];
mkdir(nameDirO);
...
runSearchlight_ShirleyRunNtempDdifName(L,inFiles,outFiles,@pileAsTimNormLoo_RSAtoolboxMatrixEoutNanInf,nsb,runN,Datafile,'optionalParams',{SPM});
