function savePileBetaMapsContrast(sub,mROI_dat,nameDir,ROI,nameAnaOf)

anaDirS = fullfile(nameDir,nameAnaOf,['sub',num2str(sub)]);%[nameDir,'/',nameAnaOf];
if ~exist(anaDirS)
    mkdir(anaDirS)
end
...
saveCImResultP1a(proHexSsNon,'proHexStrNonCol',anaDirS,ROI);
saveCImResultP1a(proClSsNon,'proClStrNonCol',anaDirS,ROI);
saveCImResultP1a(proBothSsNon,'proBothStronCol',anaDirS,ROI);
...
% save Contrast (subject level)
saveCImResultP1a(proBothSameSt,'proBothSameMap_noncol',anaDirS,ROI);
saveCImResultP1a(proHexsameSt,'proHexsameMap_noncol',anaDirS,ROI);
saveCImResultP1a(proClsameSt,'proClsameMap_noncol',anaDirS,ROI);
